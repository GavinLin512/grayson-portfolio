...
## Purpose
Defines the shared layout primitives consumed site-wide — the content/default layouts, SiteHeader (navigation + theme toggle), SiteFooter, PageHeader, the app-root SearchModal mount, shared components (TickWall, TagChip, GeoPortrait), and the playground reference page.
